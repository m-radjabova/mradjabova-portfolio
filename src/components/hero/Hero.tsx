...
/* ---------- Kursorni kuzatuvchi "magnit" yorug'lik effekti ---------- */
function useMagnetGlow<T extends HTMLElement>() {
...
const Hero = ({ onNavigate }: HeroProps) => {
  ...
  const hireBtn = useMagnetGlow<HTMLButtonElement>();
  const projectsBtn = useMagnetGlow<HTMLButtonElement>();
  const resumeBtn = useMagnetGlow<HTMLButtonElement>();
...
>
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          ...
          style={{ background: "radial-gradient(circle, #c18fa0 0%, transparent 70%)", boxShadow: "0 0 8px rgba(193,143,160,0.4)" }}
        />
        <div
          className="absolute right-[25%] top-[30%] h-1.5 w-1.5 animate-particle-rise-delayed rounded-full"
          style={{ background: "radial-gradient(circle, #b3aad7 0%, transparent 70%)", boxShadow: "0 0 6px rgba(179,170,215,0.4)" }}
        />
        <div
          className="hidden sm:block absolute left-[60%] top-[15%] h-2.5 w-2.5 animate-particle-rise-slow rounded-full"
          style={{ background: "radial-gradient(circle, #d996a4 0%, transparent 70%)", boxShadow: "0 0 10px rgba(217,150,164,0.3)" }}
        />
        <div
          className="hidden sm:block absolute right-[10%] top-[60%] h-1.5 w-1.5 animate-particle-rise rounded-full"
          style={{ background: "radial-gradient(circle, #8c83aa 0%, transparent 70%)", boxShadow: "0 0 6px rgba(140,131,170,0.4)" }}
        />
        <div
          className="absolute left-[30%] top-[70%] h-2 w-2 animate-particle-rise-delayed rounded-full"
          style={{ background: "radial-gradient(circle, #c18fa0 0%, transparent 70%)", boxShadow: "0 0 8px rgba(193,143,160,0.3)" }}
        />
      </div>
      ...
      <div className="relative z-10 mx-auto grid min-h-screen max-w-[1500px] grid-cols-1 items-center gap-4 lg:h-full lg:min-h-0 lg:grid-cols-[1fr_1.2fr] lg:gap-6">
        ...
        <div className="relative px-4 pt-16 sm:px-6 sm:pt-20 lg:px-12 lg:pt-0">
          ...
          {/* Name and role */}
          <div className="animate-hero-content-reveal mt-6 sm:mt-12" style={{ animationDelay: "0.28s" }}>
            <h2
          ...
          >
            <span className="mt-1 text-xl sm:text-2xl leading-none text-[#c18fa0] animate-float-gentle select-none">✦</span>
            <div>
              ...
              <div className="mt-4 sm:mt-6 flex flex-wrap gap-2 sm:gap-3">
                <button
                  ref={hireBtn.ref}
                  onMouseMove={hireBtn.onMouseMove}
                  type="button"
                ...
                >
                  ...
                  <span
                    ...
                    style={{ background: "radial-gradient(120px circle at var(--mx,50%) var(--my,50%), rgba(255,255,255,0.35), transparent 70%)" }}
                  />
                </button>
                ...
                >
                  ...
                  <span
                    className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                    style={{ background: "radial-gradient(120px circle at var(--mx,50%) var(--my,50%), rgba(255,255,255,0.25), transparent 70%)" }}
                  />
                </button>
                ...
                >
                  ...
                  <span
                    className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                    style={{ background: "radial-gradient(120px circle at var(--mx,50%) var(--my,50%), rgba(193,143,160,0.2), transparent 70%)" }}
                  />
                </button>
              </div>
            </div>
        ...
        <div className="relative flex h-full w-full items-end justify-center self-end lg:-ml-16 lg:justify-start">
          ...
          <div
            className="absolute -bottom-12 sm:-bottom-24 left-1/2 h-[24rem] w-[24rem] sm:h-[44rem] sm:w-[44rem] -translate-x-1/2 animate-spin-slow rounded-full border border-dashed border-[#c18fa0]/8 lg:h-[52rem] lg:w-[52rem]"
          ...
          >
            <div className="relative">
              ...
              {/* Muharrirlik burchak ramkalari — signature element */}
              {(["tl", "tr", "bl", "br"] as const).map((corner) => (
                <span
                  key={corner}
                  aria-hidden="true"
                  className={`pointer-events-none absolute z-20 h-6 w-6 sm:h-9 sm:w-9 border-[#716895]/50 transition-all duration-1000 ${
                    isPortraitLoaded ? "opacity-70" : "opacity-0"
                  } ${
                    corner === "tl" ? "left-[10%] top-[4%] border-l-2 border-t-2" :
                    corner === "tr" ? "right-[10%] top-[4%] border-r-2 border-t-2" :
                    corner === "bl" ? "left-[10%] bottom-[2%] border-l-2 border-b-2" :
                    "right-[10%] bottom-[2%] border-r-2 border-b-2"
                  }`}
                  style={{ transitionDelay: isPortraitLoaded ? "0.6s" : "0s" }}
                />
              ))}
              ...
              <img
                ...
                className={`mx-auto block h-auto w-full max-w-[28rem] object-contain transition-all duration-[1400ms] ease-out sm:max-w-[52rem] lg:max-w-[58rem] ${
                  isPortraitLoaded ? "scale-100 opacity-100 blur-0" : "scale-[0.985] opacity-0 blur-xl"
                }`}
              />
            </div>
          </div>
